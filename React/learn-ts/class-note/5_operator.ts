...
function askSomeone1(someone: Developer1 | Person1){ //모든 property에 접근할 수 없음. 타입 검증 없이는 둘의 공통 속성만 접근 가능
...
function askSomeone22(someone: Developer1 & Person1){ //둘의 속성을 모두 합한 것 접근 가능
   someone.name;
   someone.skill; //접근가능
}
